...
@Component({
    selector: "t-date-to-datetime-picker",
    templateUrl: "./t-date-to-datetime-picker.component.html",
    styleUrls: ["./t-date-to-datetime-picker.component.scss"],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => TDateToDateTimePickerComponent),
            multi: true,
        },
    ],
})
export class TDateToDateTimePickerComponent extends ControlValueAccessorConnector {
